...
@JsonPropertyOrder({
	"value"})
public class SmtRoleId implements SmtEntityIdentifier<SmtRoleId>, Comparable<SmtRoleId> {

	private String value;
	public static final String VALUE_PATTERN = "^[A-Za-z0-9]+(?:\\_[A-Za-z0-9]+)*$";
	...
	public static SmtRoleId valueOf(String value) {
		return new SmtRoleId(value);
	}
	...
	@Override
	public boolean sameValueAs(SmtRoleId other) {
		if(other == null) {
			return false;
		}
	...
	public boolean equals(Object object) {
		...
		final SmtRoleId other = (SmtRoleId) object;
	...
	@Override
	public int compareTo(SmtRoleId other) {
