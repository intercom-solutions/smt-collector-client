...
@JsonPropertyOrder({
	"value"})
public class SmtGroupCode implements SmtEntityIdentifier<SmtGroupCode>, Comparable<SmtGroupCode> {

	private String value;
	public static final String VALUE_PATTERN = "^[0-9]+(?:\\ [0-9]+)*$";
	...
	protected SmtGroupCode() {
		super();
	}

	public SmtGroupCode(String value) {
	...
	public static SmtGroupCode valueOf(String value) {
		return new SmtGroupCode(value);
	}
	...
	@Override
	public boolean sameValueAs(SmtGroupCode other) {
		if(other == null) {
			return false;
		}
	...
	public boolean equals(Object object) {
		...
		final SmtGroupCode other = (SmtGroupCode) object;
	...
	@Override
	public int compareTo(SmtGroupCode other) {
