...
@JsonPropertyOrder({
	"value"})
public class SmtBrandCode implements SmtEntityIdentifier<SmtBrandCode>, Comparable<SmtBrandCode> {
	...
	protected SmtBrandCode() {
		super();
	}

	public SmtBrandCode(String value) {
	...
	public static SmtBrandCode valueOf(String value) {
		return new SmtBrandCode(value);
	}
	...
	@Override
	public boolean sameValueAs(SmtBrandCode other) {
		if(other == null) {
			return false;
		}
	...
	public boolean equals(Object object) {
		...
		final SmtBrandCode other = (SmtBrandCode) object;
	...
	@Override
	public int compareTo(SmtBrandCode other) {
